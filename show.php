...
<div class="panel panel-primary">
      ...
      <label>ข้อมูลที่ต้องการค้นหา</label>
        ...
        <div class="row">
        <div class="col-lg-12">
        <a href="insert.php" class="btn btn-primary">เพิ่ม</a>
  ...
  <tbody>
    <?php 
        // error_reporting(0);
        include('conn.php');
        if(isset($_GET['Cel']) && isset($_GET['sb'])) {
            $i = 0;
            ...
            while ($row = mysqli_fetch_assoc($exeq)) {
                ...
                echo '<td>'.'<a href=editdata.php?car='.$car.'&price='.$price.'&qu='.$qu.'&body='.$model." class='btn btn-warning' >Edit</a>".'</td>';
                echo '</tr>';
            }
          }
    ?>
